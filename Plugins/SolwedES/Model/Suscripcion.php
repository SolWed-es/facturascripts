...
/**
 * Plugin SolwedES - Modelo de Suscripciones
 *
...
/**
 * Modelo para gestion de suscripciones de servicios SOLWED.
 */
class Suscripcion extends ModelClass
{
    use ModelTrait;
    ...
    /** @var string|null */
    public $payment_failed_at;

    /** @var int */
    public $payment_failed_count;

    /** @var bool */
    public $impago_alerta_sent;

    /** @var string|null */
    public $impago_suspended_at;
    ...
    public function clear(): void
    {
        ...
        $this->payment_failed_count = 0;
        $this->impago_alerta_sent = false;
    ...
    public static function getByReferenciaExterna(string $ref): ?self
    {
        ...
        $results = $suscripcion->all($where, [], 0, 1);
    ...
    public static function getActiveByStripeCustomerId(string $customerId): ?self
    {
        ...
        $results = $suscripcion->all($where, ['fecha_inicio' => 'DESC'], 0, 1);
    ...
    public static function getProximosAVencer(int $dias = 30): array
    {
        ...
        return $suscripcion->all($where, ['fecha_vencimiento' => 'ASC']);
    }
    ...
    public function getDominios(): array
    {
        ...
        return Dominio::getBySuscripcion($this->id);
    }
